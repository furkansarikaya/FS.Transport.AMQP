...
public interface IMessageConsumer : IDisposable
{
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Task representing the consumption operation</returns>
    Task ConsumeEventAsync<T>(string exchangeName, string routingKey, Func<T, FS.Transport.AMQP.EventHandlers.EventContext, Task<bool>> eventHandler, CancellationToken cancellationToken = default) where T : class, IEvent;
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Task representing the consumption operation</returns>
    Task ConsumeDomainEventAsync<T>(string aggregateType, Func<T, FS.Transport.AMQP.EventHandlers.EventContext, Task<bool>> eventHandler, CancellationToken cancellationToken = default) where T : class, IDomainEvent;
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Task representing the consumption operation</returns>
    Task ConsumeIntegrationEventAsync<T>(string serviceName, Func<T, FS.Transport.AMQP.EventHandlers.EventContext, Task<bool>> eventHandler, CancellationToken cancellationToken = default) where T : class, IIntegrationEvent;
