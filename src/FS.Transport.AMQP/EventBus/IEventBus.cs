...
public interface IEventBus : IDisposable
{
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Task representing the subscription operation</returns>
    Task SubscribeAsync<T>(Func<T, FS.Transport.AMQP.EventHandlers.EventContext, Task<bool>> handler, CancellationToken cancellationToken = default) where T : class, IEvent;
