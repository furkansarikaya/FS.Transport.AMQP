...
/// <summary>
/// Production-ready connection manager with auto-reconnection, pooling, and comprehensive error handling
/// </summary>
public class ConnectionManager : IConnectionManager
{
    ...
    /// <summary>
    /// Gets a channel from the pool with automatic recovery
    /// </summary>
    ...
    /// <summary>
    /// Creates a dedicated channel (not pooled)
    /// </summary>
