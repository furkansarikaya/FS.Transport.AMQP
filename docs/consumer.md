...
public class MultiTypeConsumer
{
    ...
    public MultiTypeConsumer(IStreamFlowClient streamFlow, ILogger<MultiTypeConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
    }
    ...
    {
        await _streamFlow.Consumer.ConsumeAsync<User>(
    ...
    {
        await _streamFlow.Consumer.ConsumeAsync<Product>(
...
public class PatternBasedConsumer
{
    ...
    public PatternBasedConsumer(IStreamFlowClient streamFlow, ILogger<PatternBasedConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
    }
...
public class ManualAckConsumer
{
    ...
    public ManualAckConsumer(IStreamFlowClient streamFlow, ILogger<ManualAckConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
    }
...
public class ConditionalAckConsumer
{
    ...
    public ConditionalAckConsumer(IStreamFlowClient streamFlow, ILogger<ConditionalAckConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
    }
    ...
    private async Task<ProcessingResult> ProcessOrderAsync(Order order)
    {
        ...
        catch (Exception ex)
        {
            return new ProcessingResult
            {
                Status = ex is ConnectFailureException ? "RetryableFailure" : "PermanentFailure",
                Error = ex.Message
            };
        }
    }
...
public class AutoRetryConsumer
{
    ...
    public AutoRetryConsumer(IStreamFlowClient streamFlow, ILogger<AutoRetryConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
    }
...
public class CircuitBreakerConsumer
{
    ...
    public CircuitBreakerConsumer(IStreamFlowClient streamFlow, ILogger<CircuitBreakerConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
...
public class ParallelConsumer
{
    ...
    public ParallelConsumer(IStreamFlowClient streamFlow, ILogger<ParallelConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
...
public class BatchProcessingConsumer
{
    ...
    public BatchProcessingConsumer(IStreamFlowClient streamFlow, ILogger<BatchProcessingConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
...
public class FilteringConsumer
{
    ...
    public FilteringConsumer(IStreamFlowClient streamFlow, ILogger<FilteringConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
    }
...
public class DynamicFilteringConsumer
{
    ...
    public DynamicFilteringConsumer(IStreamFlowClient streamFlow, ILogger<DynamicFilteringConsumer> logger, IConfiguration configuration)
    {
        _streamFlow = streamFlow;
        _logger = logger;
...
public class DeadLetterConsumer
{
    ...
    public DeadLetterConsumer(IStreamFlowClient streamFlow, ILogger<DeadLetterConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
    }
...
public class MonitoredConsumer
{
    ...
    public MonitoredConsumer(IStreamFlowClient streamFlow, ILogger<MonitoredConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
...
public class ConsumerHealthCheck : IHealthCheck
{
    ...
    public ConsumerHealthCheck(IStreamFlowClient streamFlow) => _streamFlow = streamFlow;

    public Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken cancellationToken = default)
    {
        var isHealthy = _streamFlow.Consumer.Status == ConsumerStatus.Running;
        var stats = _streamFlow.Consumer.Statistics;
        
        var data = new Dictionary<string, object>
        {
            ["status"] = _streamFlow.Consumer.Status.ToString(),
...
public class ExternalServiceConsumer
{
    ...
    public ExternalServiceConsumer(IStreamFlowClient streamFlow, ILogger<ExternalServiceConsumer> logger)
    {
        _streamFlow = streamFlow;
        _logger = logger;
        _circuitBreaker = new CircuitBreaker(
